...
$( document ).ready(function() {
                ...
                try{
                    ...
                    google.maps.event.addListener(map.getMap(), 'bounds_changed', (function () {
                        ...
                        return function() {
							...
							$('.outlet-all').append('<div class="text-center"><br /><p><img src="/img/loading_icon.gif" /></p><p>Đang tải dữ liệu...</p></div>');
                            clearTimeout(timer);
    ...
    $('.search input').keyup(function(b){
        ...
        if (a.length >= 2) {
            ...
            $('.search .result .ct-box').html('<div class="text-center"><br /><p><img src="/img/loading_icon.gif" /></p><p>Đang tải dữ liệu...</p></div>');
